...
<html lang="${locale}" dir="${localeDir}">
  <head>
    ...
    <meta name="description" content="${properties.description!'Teindi Workspace for profile, device, and sign-in management.'}">
    <title>${properties.title!'Teindi Workspace'}</title>
    <style>
      body {
        margin: 0;
      }
    ...
    <div id="app">
      <main class="container">
        <div class="keycloak__loading-container">
          ...
          <div>
            <p id="loading-text">Launching Teindi Workspace</p>
          </div>
        </div>
      </main>
    </div>
    <noscript>JavaScript is required to use the Teindi Workspace.</noscript>
