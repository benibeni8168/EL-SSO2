...
<html lang="en">
  <head>
    ...
    <meta name="description" content="${properties.description!'Teindi Control Center for identity, federation, and secure access operations.'}">
    <title>${properties.title!'Teindi Control Center'}</title>
    <style>
      body {
        margin: 0;
      }
      ...
      .keycloak__loading-container {
        ...
        color: #eef4fb;
        background:
          radial-gradient(circle at top right, rgba(90, 164, 255, 0.2), transparent 24%),
          radial-gradient(circle at bottom left, rgba(255, 113, 52, 0.18), transparent 28%),
          linear-gradient(180deg, #091321 0%, #112238 100%);
        display: flex;
        align-items: center;
    ...
    <div id="app">
      <main class="container">
        <div class="keycloak__loading-container">
          ...
          <div>
            <p id="loading-text">Launching Teindi Control Center</p>
          </div>
        </div>
      </main>
    </div>
    <noscript>JavaScript is required to use the Teindi Control Center.</noscript>
