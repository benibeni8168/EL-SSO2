...
export const LoginPreviewWindow = ({ cssVars }: LoginPreviewWindowProps) => {
  ...
  const defaultBgImage = `${resourceUrlRoot}/welcome/keycloak/background.svg`;
  const defaultLogo = `${loginResourceUrl}/img/teindi-logo-full.png`;
              ...
              <div className={properties.kcLoginContainer}>
                <header id="kc-header" className="pf-v5-c-login__header">
                  <div id="kc-header-wrapper" className="pf-v5-c-brand">
                    <span className="teindi-brand-badge">Teindi Secure Access</span>
                    <img className="teindi-brand-logo" src={logoUrl} alt="Teindi" />
                    <p className="teindi-brand-copy">
                      Discreet identity, federation, and account access for the
                      Teindi platform.
                    </p>
                  </div>
                </header>
