...
import { PamSettingsForm } from "./pam/PamSettingsForm";
import { IncidentSettingsForm } from "./incident/IncidentSettingsForm";
...
export const RealmSettingsTabs = () => {
  ...
  const pamTab = useTab("pam");
  const incidentTab = useTab("incident");
  const cloudAppsTab = useTab("cloud-apps");
    ...
    <FormProvider {...form}>
      ...
      <PageSection variant="light" className="pf-v5-u-p-0">
        ...
        >
          ...
          <Tab
            title={<TabTitleText>{t("pam")}</TabTitleText>}
            data-testid="rs-pam-tab"
            {...pamTab}
          >
            <PamSettingsForm />
          </Tab>
          <Tab
            title={<TabTitleText>{t("incident")}</TabTitleText>}
            data-testid="rs-incident-tab"
            {...incidentTab}
          >
            <IncidentSettingsForm />
          </Tab>
          <Tab
            title={<TabTitleText>{t("cloudApps")}</TabTitleText>}
            data-testid="rs-cloud-apps-tab"
            {...cloudAppsTab}
          >
            <CloudAppsTab />
          </Tab>
