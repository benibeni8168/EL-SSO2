...
/**
 * Resource for security-sensitive event reports.
 */
public class SecurityReportResource {

    /**
     * Security-sensitive event types for monitoring.
     */
    private static final Set<EventType> SECURITY_EVENT_TYPES = Set.of(
        EventType.RESET_PASSWORD, EventType.RESET_PASSWORD_ERROR,
        EventType.UPDATE_CREDENTIAL, EventType.UPDATE_CREDENTIAL_ERROR,
        EventType.REMOVE_CREDENTIAL, EventType.REMOVE_CREDENTIAL_ERROR,
        EventType.USER_DISABLED_BY_PERMANENT_LOCKOUT, EventType.USER_DISABLED_BY_PERMANENT_LOCKOUT_ERROR,
        EventType.USER_DISABLED_BY_TEMPORARY_LOCKOUT, EventType.USER_DISABLED_BY_TEMPORARY_LOCKOUT_ERROR,
    ...
    public SecurityReportResource(KeycloakSession session, RealmModel realm, AdminPermissionEvaluator auth) {
    ...
    public ReportSummary getSummary(
        ...
        // Filter to security-sensitive events only
        query.type(SECURITY_EVENT_TYPES.toArray(new EventType[0]));
    ...
    public Response export(
        ...
        if ("csv".equalsIgnoreCase(format)) {
            ...
            return Response.ok(stream)
                    .type("text/csv")
                    .header("Content-Disposition", "attachment; filename=\"security-events.csv\"")
                    .build();
        } else {
            ...
            return Response.ok(stream)
                    ...
                    .header("Content-Disposition", "attachment; filename=\"security-events.json\"")
                    .build();
        }
    }
    ...
    private ReportSummary buildSummary(List<Event> events, String dateFrom, String dateTo) {
        ...
        summary.setReportType("Security");
        return summary;
    }
}
