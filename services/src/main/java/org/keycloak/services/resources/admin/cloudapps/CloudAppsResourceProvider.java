...
public final class CloudAppsResourceProvider
        implements AdminRealmResourceProviderFactory, AdminRealmResourceProvider {

    public static final String PROVIDER_ID = "cloud-apps";
    ...
    public Object getResource(KeycloakSession session, RealmModel realm,
        ...
        return new CloudAppsResource(session, realm, auth, adminEvent);
    }
}
